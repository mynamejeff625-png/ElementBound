...
async function ebBalanceCalibrationRun(){
 ...
 try{
  ...
  EB_BL_CAL_LAST={build:EB_RELEASE.version,ruleset:ebBalanceRuleset(),depth,total,stalls,sideWins,aPct,bPct,mirrorA,mirrorB,mAPct,mBPct,detected,flips,stable,mirror,pairRows,elapsedMs:Math.round(performance.now()-started)};
