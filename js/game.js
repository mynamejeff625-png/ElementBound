...
WATER:[['Mist Adept',1,1,3,'On summon: Flow 1.','Smooths your next draw and gives Water a stable opener.'],['Tide Warden',2,1,4,'Guard. When damaged, Flow 1.','Defends while improving future draws.'],['River Serpent',3,2,4,'When this damages a Manifestation, apply Soaked.','Sets up Water control effects.']],
NATURE:[['Sproutling',1,1,3,'On summon: give another friendly Manifestation Seeded.','Seed an established ally such as Grove Beast so Verdant Mend can convert that setup into Growth. If no other ally is present, the summon still resolves but Seeded is not applied.'],['Root Keeper',2,2,4,'When healed, gain 1 Growth, max 3.','Turns healing into permanent board development.'],['Grove Beast',3,2,5,'Gets +1 ATK for each Growth on it.','Late payoff for building Growth.']],
EARTH:[['Stone Initiate',1,1,3,'On summon: give another friendly Manifestation 1 Armor, max 3.','Redistribute Earth defense onto an established ally; the Armor is not forced onto Stone Initiate.'],['Earthen Guard',2,1,5,'Guard.','Protects your Bender while it remains on the field, even after it attacks.'],['Boulder Ram',3,3,5,'If it has Armor when it attacks, deal +1 damage.','Converts Earth defense into pressure.']],
LIGHTNING:[['Spark Runner',1,2,2,'If this is your second card played this turn, gain +1 Chain.','Chain accelerator: play it second to jump directly from Chain 2 to Chain 3.'],['Arc Runner',2,2,3,'At Chain 2+, this gets +1 ATK this turn.','Rewards playing cards in sequence before attacking.'],['Volt Lynx',3,4,2,'At Chain 3+, its first attack each turn deals +1 damage.','Fragile but explosive combo payoff.']],
AIR:[['Breeze Disciple',1,1,3,'On summon: give another friendly Manifestation Momentum.','Put Momentum onto an established ally such as Sky Raptor to unlock Air’s pressure payoff.'],['Gale Scout',2,2,3,'After Crosswind moves an enemy, this gets +1 ATK on its next attack that turn.','Use Crosswind first, then attack to exploit the opening.'],['Sky Raptor',3,3,3,'If it has Momentum, it may attack the Bender ignoring Guard.','Air pressure payoff: give Sky Raptor Momentum, then it can legally choose the rival Bender even while Guard is active.']]};
const RESPONSES={
...
NATURE:{n:'Second Bloom',c:2,text:'When one of your Manifestations is attacked, heal a damaged friendly Manifestation for 2.',tip:'Stabilize any damaged ally before the incoming attack resolves.'},
EARTH:{n:'Stonewall',c:2,text:'When one of your Manifestations is attacked, give a friendly Manifestation +1 Armor.',tip:'Permanent protection. Armor remains until consumed by damage.'},
...
NATURE:['Verdant Mend','Heal a friendly Manifestation for 2. If it is Seeded, give it 1 Growth.','Turns an established Nature body into a scaling threat.',2],
EARTH:['Fortify','Give a friendly Manifestation 1 Armor, max 3.','Use before an enemy attack or to enable Armor payoffs.',1],
...
AIR:['Crosswind','Move an enemy Manifestation to another open slot. If none is present, Flow 1.','Disrupts positioning without becoming a dead card.',1]};
const HYBRID_CARDS={
MAGMA:[
 {n:'Molten Channel',c:2,type:'TECHNIQUE',role:'SETUP',text:'Choose: give a friendly Manifestation 1 Armor, or apply Burning to an enemy Manifestation damaged this turn. Resonance — choose both.',tip:'Flexible Magma setup; Resonance combines defense and pressure.'},
 {n:'Obsidian Ravager',c:4,type:'MANIFESTATION',a:4,h:5,role:'AVATAR',text:'Once per turn when this attacks during Resonance, you may remove 1 Armor from another friendly Manifestation to apply Burning to the defender.',tip:'Turns established Armor into pressure.'},
 {n:'Pressure Forge',c:3,type:'TECHNIQUE',role:'PAYOFF',text:'Give a friendly Manifestation 1 Armor. Resonance — if an enemy is Burning, deal 1 damage to it.',tip:'Safe defensive value with a controlled Resonance payoff.'},
 {n:'Eruption Guard',c:2,type:'TECHNIQUE',role:'QUICK',text:'Choose a friendly Manifestation. Until your next turn, the next attack damage it takes is reduced by 2.',tip:'Pre-commit protection before the rival turn.'}],
STORM:[
 {n:'Crosswind Spark',c:1,type:'TECHNIQUE',role:'SETUP',text:'Move a friendly Manifestation to an empty friendly slot and give it Momentum. Resonance — it also becomes Charged.',tip:'Repositions and prepares Storm payoffs.'},
 ...
 {n:'Thunderstep',c:2,type:'TECHNIQUE',role:'PAYOFF',text:'Move a friendly Manifestation to an empty slot. Resonance — if it is Charged or has Momentum, deal 1 damage to an enemy Manifestation.',tip:'Converts movement setup into controlled damage.'},
...
BLOOM:[
 {n:'Rainseed',c:1,type:'TECHNIQUE',role:'SETUP',text:'Give a friendly Manifestation Seeded; if already Seeded, heal it 1. Resonance — instead give it 1 Growth, max 3.',tip:'Builds Bloom resources without unrestricted healing.'},
 {n:'Tidelily Guardian',c:3,type:'MANIFESTATION',a:2,h:5,role:'AVATAR',text:'The first time each turn this gains Growth, heal another friendly Manifestation 1. Resonance — you may instead heal your Bender 1.',tip:'Sustain avatar that rewards Growth setup.'},
 {n:'Flourishing Current',c:3,type:'TECHNIQUE',role:'PAYOFF',text:'Heal a friendly Manifestation 2. Resonance — if it is Seeded, give it 1 Growth, max 3.',tip:'Turns established Bloom setup into durable value.'},
...
'Armor':'Damage protection attached to a specific Manifestation. Each Armor prevents 1 damage to that Manifestation and is then consumed. A Manifestation can hold up to 3 Armor; Stone Initiate can give 1 Armor to another friendly Manifestation when summoned.',
...
'Soaked':'Water’s setup mark. When a Water Manifestation damages a Soaked Manifestation, you Flow 1, then Soaked is removed. This turns setup into better future draws.',
...
'Charged':'Lightning’s payoff mark. The next Lightning attack that hits a Charged target deals +1 damage, then Charged is consumed.',
'Momentum':'Air’s movement/tempo setup effect placed on a specific Manifestation. Breeze Disciple can give Momentum to another friendly Manifestation. While Sky Raptor has Momentum, its own card effect is enabled and it may attack the rival Bender ignoring Guard.',
...
function mk(el,n,c,a,h,guard=false,text='',tip=''){return{id:++uid,el,n,c,type:'MANIFESTATION',a,h,max:h,armor:0,ready:true,sick:false,guard,zone:'DECK',text,tip,marks:[],growth:0,role:null,quick:null,turnFlags:{}}}
...
function startTrial(el){
  ...
  if(el==='FIRE'){
    ...
    trial={
      ...
      icon:'🌪️',
      objective:'Use Crosswind to MOVE Stone Initiate → then attack it with Gale Scout to EXPLOIT the opening.',
      fail:'Move the target first. Then attack it.',
      mastered:'MOVE → EXPLOIT',
      progress:{step:0,moved:false,exploited:false,targetId:target.id}
    };
  }else if(el==='EARTH'){
...
function chooseTechniqueTarget(c){
 ...
 if(HYBRIDS[c.el]){
   ...
   if(c.el==='MAGMA'){
     if(c.n==='Molten Channel'||c.n==='Pressure Forge'||c.n==='Eruption Guard') p.slots.forEach((m,i)=>{if(m)opts.push([`${m.n} · M${i+1}`,()=>commit({friend:m})])});
   }else if(c.el==='STORM'){
   ...
   e.slots.forEach((m,i)=>{if(!m)return;opts.push([`${m.n} · M${i+1}`,()=>{
     let dest=e.slots.map((x,j)=>!x?j:-1).filter(j=>j>=0);
     if(!dest.length)return commit({flowOnly:true});
     modal(`Move ${m.n} to…`,dest.map(j=>[`M${j+1}`,()=>commit({enemy:m,to:j})]));
   }])});
   if(!opts.length)return commit({flowOnly:true});
...
function applyPrimeSummonGift(c,target){
 ...
 if(c.el==='AIR'&&c.n==='Breeze Disciple'){
   addMark(target,'Momentum');
   add(`${c.n}: ${target.n} gains Momentum`);
   return true;
 }
 if(c.el==='EARTH'&&c.n==='Stone Initiate'){
   let before=target.armor||0;
   target.armor=Math.min(3,before+1);
   add(`${c.n}: ${target.n} gains 1 Armor → ${target.armor}`);
   return true;
 }
...
if(c.type==='TECHNIQUE'){sendToWake(p,c,'technique');
 if(HYBRIDS[c.el]){resolveHybridTechnique(p,foe(),c,false,techTarget)}
 ...
 else if(c.el==='EARTH'){let t=techTarget&&techTarget.friend;if(t){t.armor=Math.min(3,(t.armor||0)+1);add(`${c.n}: ${t.n} gains 1 Armor`);if(G.trial&&G.trial.element==='EARTH')resolveStoneTrial()}else add(`${c.n}: no friendly target`)}
 else if(c.el==='NATURE'){let t=techTarget&&techTarget.friend;if(t){t.h=Math.min(t.max,t.h+2);if((t.marks||[]).includes('Seeded')&&t.growth<3){t.growth++;t.a++;add(`${c.n}: heal + Seeded → Growth ${t.growth}`)}else add(`${c.n}: heals ${t.n} for up to 2`)}}
  ...
  let arr=foe().slots,m=techTarget&&techTarget.enemy,from=m?arr.indexOf(m):-1,to=(techTarget&&Number.isInteger(techTarget.to))?techTarget.to:-1;
  if(from>=0&&to>=0&&!arr[to]){
    arr[from]=null;arr[to]=m;
    ...
    add(`${c.n}: moves ${m.n} M${from+1}→M${to+1} · Air Opening ready`);
    if(G.trial&&G.trial.element==='AIR'&&c.n==='Crosswind'&&m.id===G.trial.progress.targetId){
      G.trial.progress.moved=true;G.trial.progress.step=1;
      add('WINDS · MOVE complete → attack Stone Initiate with Gale Scout.');
    }
  }else {add(`${c.n}: Flow 1 (no legal movement)`);flow1(p,false)};
}
...
function grow(m){if((m.growth||0)>=3)return false;m.growth=(m.growth||0)+1;m.a++;return true}
...
function resolveHybridTechnique(p,e,c,isAI=false,target=null){let r=resonant(p),friend=(target&&target.friend)||p.slots.find(Boolean),enemy=(target&&target.enemy)||e.slots.find(Boolean);
 if(c.el==='MAGMA'){if(c.n==='Molten Channel'){if(friend){friend.armor=Math.min(3,(friend.armor||0)+1);add(`${c.n}: ${friend.n} gains Armor`)}if(r&&enemy){addMark(enemy,'Burning');add(`${c.n}: Resonance applies Burning`)}}else if(c.n==='Pressure Forge'){if(friend)friend.armor=Math.min(3,(friend.armor||0)+1);if(r){let t=e.slots.find(x=>x&&(x.marks||[]).includes('Burning'));if(t){hit(t,1);death(e);add(`${c.n}: Resonance deals 1`)}}}else if(c.n==='Eruption Guard'&&friend){friend.quick={kind:'REDUCE',value:2,ownerTurn:G.turn};add(`${c.n}: protection armed`)}}
 if(c.el==='STORM'){if(c.n==='Crosswind Spark'&&friend&&moveFriendly(p,friend)){addMark(friend,'Momentum');if(r)addMark(friend,'Charged');add(`${c.n}: movement + Momentum${r?' + Charged':''}`)}else if(c.n==='Thunderstep'&&friend&&moveFriendly(p,friend)){if(r&&((friend.marks||[]).includes('Charged')||(friend.marks||[]).includes('Momentum'))&&enemy){hit(enemy,1);death(e);add(`${c.n}: Resonance deals 1`)}}else if(c.n==='Static Reversal'&&friend){friend.quick={kind:'MOVE',ownerTurn:G.turn};add(`${c.n}: reversal armed`)}}
 if(c.el==='BLOOM'){if(c.n==='Rainseed'&&friend){if(r){if(grow(friend))add(`${c.n}: Resonance Growth ${friend.growth}`)}else if((friend.marks||[]).includes('Seeded')){friend.h=Math.min(friend.max,friend.h+1);add(`${c.n}: heals 1`)}else{addMark(friend,'Seeded');add(`${c.n}: Seeded`)}}else if(c.n==='Flourishing Current'&&friend){friend.h=Math.min(friend.max,friend.h+2);if(r&&(friend.marks||[]).includes('Seeded'))grow(friend);add(`${c.n}: heal${r?' + Resonance':''}`)}else if(c.n==='Reclaiming Tide'){let t=p.slots.find(x=>x&&(x.marks||[]).includes('Seeded')&&(x.growth||0)>0);if(t){t.quick={kind:'SURVIVE',ownerTurn:G.turn};add(`${c.n}: survival armed on ${t.n}`)}}}}
...
function hybridAttackBonus(att,p){
 ...
 // Primary Air payoff: Crosswind repositioning creates one +1 ATK opening
 // for Gale Scout this turn. Consume it on the Scout's attack.
 if(att.el==='AIR'&&att.n==='Gale Scout'&&p.turnState.airOpening){
   bonus+=1;
   p.turnState.airOpening=false;
   add('AIR · Gale Scout exploits Crosswind → +1 ATK');
 }
 return bonus;
}
...
function attackBypassesGuard(att,owner){
 ...
 if(att.el==='AIR'&&att.n==='Sky Raptor'&&(att.marks||[]).includes('Momentum')){
   return true;
 }
...
function ebResponseLegal(el,defender,attacker,target,phase='BEFORE'){
 ...
 if(el==='NATURE')return defender.slots.some(m=>m&&m.h<m.max);
...
function ebResponseTargetChoices(el,p,target){if(el==='NATURE')return p.slots.filter(m=>m&&m.h<m.max);if(el==='EARTH')return p.slots.filter(Boolean);if(el==='AIR')return p.slots.filter(m=>m&&m!==target);return [target]}
function ebResolveResponse(opt,defender,attacker,target,pick=null,phase='BEFORE'){
 ...
 else if(opt.el==='NATURE'){if(chosen&&defender.slots.includes(chosen)){let before=chosen.h;chosen.h=Math.min(chosen.max,chosen.h+2);add(`Second Bloom heals ${chosen.n} for ${chosen.h-before}`)}}
 else if(opt.el==='EARTH'){if(chosen&&defender.slots.includes(chosen)){let old=chosen.armor||0;chosen.armor=Math.min(3,old+1);add(`Stonewall → ${chosen.n} gains ${chosen.armor-old} Armor`)}}
...
function ebAttackCore(att,t){hideModal();let defending=foe(),owner=me();
 ...
 att.ready=false;if(t){applyQuickBeforeAttack(foe(),t);let q=t.quick&&t.quick.kind==='REDUCE'?t.quick.value:0;if(q)t.quick=null;let power=Math.max(0,att.a+elementalAttackBonus(att,t,me())-q);
if(G.trial&&G.trial.element==='AIR'&&att.n==='Gale Scout'&&t&&t.id===G.trial.progress.targetId){
  if(!G.trial.progress.moved){
    power=0;
    att.ready=true;
    add('WINDS · No opening yet → use Crosswind first.');
  }else{
    power+=1;
    G.trial.progress.exploited=true;G.trial.progress.step=2;
    add('WINDS · EXPLOIT → repositioning creates +1 trial damage.');
  }
}
...
if(G.trial&&G.trial.element==='NATURE'&&att.n==='Grove Beast'){
...
}let wasSoaked=(t.marks||[]).includes('Soaked');
 let preHitHP=t.h,guardsAtImpact=activeGuards(foe()).length;
 ...
 // Track pre-hit Soaked state so a newly applied mark is not consumed instantly.
 if(att.el==='WATER'&&att.n==='River Serpent'&&d>0){
   addMark(t,'Soaked');
   add(`WATER · River Serpent damages ${t.n} → Soaked`);
 }
 // Existing Soaked is Water's setup payoff: connect, Flow 1, then consume it.
 if(att.el==='WATER'&&d>0&&wasSoaked){
   t.marks=t.marks.filter(x=>x!=='Soaked');
   add(`SOAKED · ${att.n} connects → Flow 1 · Soaked consumed`);
   flow1(me(),false);
 }
 applyQuickAfterDamage(foe(),t);resolveOverflowDamage(foe(),t,d,preHitHP,guardsAtImpact,att.el,att.n,1);death(foe());winCheck();if(G.trial&&G.trial.element==='WATER'&&G.trial.progress.soaked&&!foe().slots.some(Boolean)){foe().vit=0;add('TIDE TRIAL · Soak → Strike complete')}if(G.trial&&G.trial.element==='LIGHTNING'&&G.trial.progress.released){foe().vit=0;add('STORMS TRIAL · Charge → Release complete')}if(G.trial&&G.trial.element==='AIR'&&G.trial.progress.exploited){foe().vit=0;add('WINDS TRIAL · Move → Exploit complete')}if(G.trial&&G.trial.element==='NATURE'&&G.trial.progress.step===1&&G.trial.progress.techniqueApplied&&G.trial.progress.grew&&att.n==='Grove Beast'&&!foe().slots.some(Boolean)){foe().vit=0;add('ROOTS TRIAL · Grow → Strike complete')}}else{let power=Math.max(0,att.a+elementalAttackBonus(att,foe(),me()));foe().vit-=power;ebQueueFx({kind:'benderHit',side:1,damage:power,el:att.el,label:att.n});add(`${att.n} hits rival Bender for ${power}`)}bump()}
...
function turnStart(){
 // Lifecycle hotfix: orphanable Bender setup marks cannot persist indefinitely across turns.
 if(G&&G.p)G.p.forEach(side=>{if((side.marks||[]).includes('Charged'))side.marks=side.marks.filter(x=>x!=='Charged')});
...
function techScore(c){if(HYBRIDS[c.el])return resonant(p)?7:4;if(c.el==='FIRE')return e.slots.some(Boolean)?7:2;if(c.el==='EARTH')return p.slots.some(Boolean)?6:0;if(c.el==='NATURE')return p.slots.some(m=>m&&m.h<m.max)?7:1;if(c.el==='WATER')return 4;if(c.el==='LIGHTNING')return G.chain>=1?6:3;if(c.el==='AIR')return e.slots.some(Boolean)?5:2;return 2}
for(let step=0;step<budget;step++){let legal=p.hand.filter(c=>c.c<=p.e&&(c.type==='TECHNIQUE'||p.slots.some(s=>!s)));if(!legal.length)break;let c;
 ...
 if(c.type==='TECHNIQUE'){sendToWake(p,c,'technique');
   ...
   else if(c.el==='EARTH'){let t=p.slots.filter(Boolean).sort((a,b)=>(b.a+b.h)-(a.a+a.h))[0];if(t){t.armor=Math.min(3,(t.armor||0)+1);add(`Rival Fortify → ${t.n} Armor ${t.armor}`)}}
   else if(c.el==='NATURE'){let t=p.slots.filter(Boolean).sort((a,b)=>(a.h/a.max)-(b.h/b.max))[0];if(t){t.h=Math.min(t.max,t.h+2);add(`Rival Verdant Mend heals ${t.n}`)}}
   ...
   else if(c.el==='AIR'){let from=e.slots.findIndex(Boolean),to=e.slots.findIndex(x=>!x);if(from>=0&&to>=0){let m=e.slots[from];e.slots[from]=null;e.slots[to]=m;add(`Rival Crosswind moves ${m.n}`)}else add(`Rival Crosswind: Flow 1`)}
 }else{let i=p.slots.findIndex(x=>!x);if(i<0)continue;c.zone='FIELD';c.sick=true;c.ready=true;c.marks=c.marks||[];p.slots[i]=c;if(c.el==='LIGHTNING'&&c.n==='Spark Runner'&&G.chain===2){G.chain++;add(`Rival ${c.n}: second card → +1 Chain (Chain ${G.chain})`);ebPulseChain()}resolvePrimeSummonGift(p,c,true);add(`Rival summons ${c.n}`)}
...
let attackers=p.slots.filter(x=>x&&x.ready&&!x.sick);if(diff==='Easy')attackers=attackers.slice(0,1);
 function finishAI(){bump();if(!G.winner){G.active=0;G.turn++;turnStart()}}
 function nextAttack(i){if(G.winner||i>=attackers.length)return finishAI();let m=attackers[i];if(!p.slots.includes(m)||!m.ready||m.sick)return nextAttack(i+1);m.ready=false;let guards=activeGuards(e),targets=e.slots.filter(Boolean),t=null;let canBypass=guards.length>0&&attackBypassesGuard(m,p);if(canBypass&&diff==='Difficult')t=null;else if(targets.length){t=diff==='Easy'?targets[Math.floor(Math.random()*targets.length)]:ebPickAITarget(m,targets,Math.random)}
  if(!t){let power=Math.max(0,m.a+elementalAttackBonus(m,e,p));e.vit-=power;ebQueueFx({kind:'benderHit',side:0,damage:power,el:m.el,label:m.n});add(`Rival ${m.n} hits Bender for ${power}`);winCheck();return nextAttack(i+1)}
  ebChooseHumanResponse(m,t,'BEFORE',rr=>{if(rr.cancel||G.winner)return nextAttack(i+1);t=rr.target;if(!e.slots.includes(t))return nextAttack(i+1);applyQuickBeforeAttack(e,t);let q=t.quick&&t.quick.kind==='REDUCE'?t.quick.value:0;if(q)t.quick=null;let power=Math.max(0,m.a+elementalAttackBonus(m,t,p)-q);let wasSoaked=(t.marks||[]).includes('Soaked'),preHitHP=t.h,guardsAtImpact=activeGuards(e).length;let d=hit(t,power,m.el,m.n);add(`Rival ${m.n} attacks ${t.n} for ${d}`);if(m.el==='WATER'&&m.n==='River Serpent'&&d>0){addMark(t,'Soaked');add(`Rival River Serpent → Soaked`)}if(m.el==='WATER'&&d>0&&wasSoaked){t.marks=t.marks.filter(x=>x!=='Soaked');add(`Rival SOAKED payoff → Flow 1`);flow1(p,true)}applyQuickAfterDamage(e,t);resolveOverflowDamage(e,t,d,preHitHP,guardsAtImpact,m.el,m.n,0);let survived=e.slots.includes(t);death(e);winCheck();if(G.winner)return nextAttack(i+1);if(d>0){ebChooseHumanResponse(m,t,'AFTER',()=>nextAttack(i+1))}else nextAttack(i+1)})
 }
 nextAttack(0)}
...
function ebSnap(){
 if(!G)return null;
 return {p:G.p.map(p=>({vit:p.vit,marks:[...(p.marks||[])],slots:p.slots.map((c,i)=>c?{id:c.id,n:c.n,el:c.el,h:c.h,a:c.a,armor:c.armor||0,growth:c.growth||0,ready:!!c.ready,sick:!!c.sick,marks:[...(c.marks||[])],quick:c.quick?c.quick.kind:null,slot:i}:null)}))};
}
...
function ebShortFocus(log){
 ...
 if(/AIR · Gale Scout exploits/i.test(s))return['OPENING EXPLOITED · +1 ATK','AIR'];
...
function effectBadges(c){
 let b=[];
 (c.marks||[]).forEach(x=>b.push(`<span class="effect-badge effect-pop">${x}</span>`));
...
function ebCard(el,name){let c=deck(el).find(x=>x.n===name);if(!c)throw new Error(`Missing card: ${el}/${name}`);return c}
 ...
 return {turn:Number(state.turn||0),active:Number(state.active||0),rev:Number(state.rev||0),winner:state.winner??null,
  p:(state.p||[]).map(p=>({vit:p.vit,ess:p.ess,maxEss:p.maxEss,
   ...
   marks:[...(p.marks||[])],slots:(p.slots||[]).map(c=>c?{id:c.id,n:c.n,el:c.el,h:c.h,max:c.max,a:c.a,
    armor:c.armor||0,growth:c.growth||0,ready:!!c.ready,sick:!!c.sick,marks:[...(c.marks||[])]}:null)}))};
}
...
function runEBVerification(){
 ...
 try{
  ...
  test('DATA','Prime Manifestation costs are canonical',()=>{for(const el of Object.keys(BASE)){BASE[el].forEach((x,i)=>ebAssert(x[1]===i+1,`${el} ${x[0]} cost ${x[1]} expected ${i+1}`))}});
  ...
  test('WATER','River Serpent newly applied Soaked is not consumed on same hit',()=>{let x=ebAttackCore.toString();ebAssert(x.includes('wasSoaked')&&x.indexOf("addMark(t,'Soaked')")<x.indexOf('&&wasSoaked'))});
  test('WATER','Flow preview exposes readable card type stats and effect',()=>{let c=ebCard('WATER','Tide Warden');let x=flowPreview(c),effect=c.text||c.txt;ebAssert(x.includes('Manifestation')&&x.includes('Guard')&&x.includes('ATK')&&x.includes('HP')&&x.includes('Essence')&&effect&&x.includes(effect)&&!x.includes('<div'))});
  test('WATER','Flow 1 resolver exists and preserves deck size',()=>{let p=ebTestPlayer('WATER');p.deck=[ebCard('WATER','Mist Adept'),ebCard('WATER','Tide Warden')];let n=p.deck.length;G={p:[p,ebTestPlayer()],active:0,chain:0,logs:[],turn:1};ebAssert(typeof flow1==='function'&&p.deck.length===n)});
  test('WATER','Soaked is a registered visible effect',()=>ebAssert(/Water’s setup mark/.test(GLOSSARY.Soaked)&&/Flow 1/.test(GLOSSARY.Soaked)));
  test('WATER','Soaked payoff is Water-only by rule',()=>ebAssert(/att\.el==='WATER'/.test(ebAttackCore.toString())&&/Soaked consumed/.test(ebAttackCore.toString())));
  test('EARTH','Boulder Ram gets +1 ATK while Armored',()=>{let p=ebTestPlayer('EARTH'),e=ebTestPlayer();G={p:[p,e],active:0,chain:0,logs:[]};let a=ebCard('EARTH','Boulder Ram');a.armor=1;ebAssert(elementalAttackBonus(a,e,p)===1)});
  test('EARTH','Boulder Ram gets no bonus without Armor',()=>{let p=ebTestPlayer('EARTH'),e=ebTestPlayer();G={p:[p,e],active:0,chain:0,logs:[]};let a=ebCard('EARTH','Boulder Ram');a.armor=0;ebAssert(elementalAttackBonus(a,e,p)===0)});
  test('FIRE','Flare Hawk gets +1 vs Burning Manifestation',()=>{let p=ebTestPlayer('FIRE'),e=ebTestPlayer('WATER');G={p:[p,e],active:0,chain:0,logs:[]};let a=ebCard('FIRE','Flare Hawk'),t={marks:['Burning']};ebAssert(elementalAttackBonus(a,t,p)===1)});
  test('FIRE','Flare Hawk gets +1 vs Burning Bender',()=>{let p=ebTestPlayer('FIRE'),e=ebTestPlayer('WATER');e.marks=['Burning'];G={p:[p,e],active:0,chain:0,logs:[]};let a=ebCard('FIRE','Flare Hawk');ebAssert(elementalAttackBonus(a,e,p)===1)});
  test('LIGHTNING','Arc Runner gets +1 at Chain 2',()=>{let p=ebTestPlayer('LIGHTNING'),e=ebTestPlayer();G={p:[p,e],active:0,chain:2,logs:[]};ebAssert(elementalAttackBonus(ebCard('LIGHTNING','Arc Runner'),e,p)===1)});
  test('LIGHTNING','Arc Runner gets no Chain bonus below 2',()=>{let p=ebTestPlayer('LIGHTNING'),e=ebTestPlayer();G={p:[p,e],active:0,chain:1,logs:[]};ebAssert(elementalAttackBonus(ebCard('LIGHTNING','Arc Runner'),e,p)===0)});
  test('LIGHTNING','Charged adds +1 to Lightning attack',()=>{let p=ebTestPlayer('LIGHTNING'),e=ebTestPlayer();e.marks=['Charged'];G={p:[p,e],active:0,chain:0,logs:[]};ebAssert(elementalAttackBonus(ebCard('LIGHTNING','Spark Runner'),e,p)===1)});
  test('LIGHTNING','Charged is consumed on release',()=>{let p=ebTestPlayer('LIGHTNING'),e=ebTestPlayer();e.marks=['Charged'];G={p:[p,e],active:0,chain:0,logs:[]};elementalAttackBonus(ebCard('LIGHTNING','Spark Runner'),e,p);ebAssert(!e.marks.includes('Charged'))});
  test('LIGHTNING','Arc Runner + Chain 2 + Charged stacks to +2',()=>{let p=ebTestPlayer('LIGHTNING'),e=ebTestPlayer();e.marks=['Charged'];G={p:[p,e],active:0,chain:2,logs:[]};ebAssert(elementalAttackBonus(ebCard('LIGHTNING','Arc Runner'),e,p)===2)});
  test('AIR','Crosswind opening gives Gale Scout +1 once',()=>{let p=ebTestPlayer('AIR'),e=ebTestPlayer();p.turnState.airOpening=true;G={p:[p,e],active:0,chain:0,logs:[]};let a=ebCard('AIR','Gale Scout');ebAssert(hybridAttackBonus(a,p)===1&&!p.turnState.airOpening)});
 ...
 test('UI','Battlefield rail permits horizontal and vertical pan',()=>{let rule=[...document.styleSheets].flatMap(ss=>{try{return [...ss.cssRules]}catch(e){return[]}}).find(r=>r.selectorText==='#battle .slots'&&String(r.style.touchAction||'').includes('pan-x'));ebAssert(rule&&String(rule.style.touchAction).includes('pan-y'),'field touch-action must permit pan-x and pan-y')});
   ...
   test('UI','Reduced-motion navigation fallback exists',()=>ebAssert(document.getElementById('eb-0830-mobile-navigation')&&document.getElementById('eb-0830-mobile-navigation').textContent.includes('prefers-reduced-motion'),'reduced motion CSS missing'));
   test('FX','Elemental FX 2.0 stylesheet is installed',()=>ebAssert(!!document.getElementById('eb-0831-elemental-fx'),'0.8.31 FX stylesheet missing'));
  ...
  test('AI/TARGETING','Lethal target is prioritized over nonlethal slot order',()=>{let a={a:3},tank={id:'tank',a:4,h:6,armor:1,marks:[]},kill={id:'kill',a:2,h:2,armor:0,marks:[]};ebAssert(ebPickAITarget(a,[tank,kill],()=>0)===kill&&ebPickAITarget(a,[kill,tank],()=>0)===kill,'Lethal target was not consistently prioritized')});
   ...
   test('BALANCE LAB','Quick/Standard/Deep controls are registered',()=>{let vals=[...document.querySelectorAll('[data-bl-depth]')].map(x=>Number(x.dataset.blDepth));ebAssert([10,50,100].every(x=>vals.includes(x)),'Simulation depth control missing')});
    test('BALANCE LAB','Paired deterministic calibration is registered',()=>{let r=EB_BALANCE.paired('FIRE','WATER',2,{seedBase:'phase-cal'});ebAssert(r&&r.pairs.length===2&&r.games===4,'Paired calibration helper missing or malformed')});
 ...
 summary.innerHTML=`<b>SYSTEM HEALTH: ${pass} / ${total} PASSING</b><div class="small">${pct}% verified · ${total-pass} issue${total-pass===1?'':'s'} detected</div><div class="devBar"><i style="width:${pct}%"></i></div>`;
 ...
 EB_DEV_LAST_REPORT=[`ELEMENT BOUND Alpha 0.8.53 SYSTEM CHECK`,`${pass}/${total} PASSING`,...results.map(r=>`${r.ok?'PASS':'FAIL'} [${r.group}] ${r.name}${r.detail?' — '+r.detail:''}`)].join('\n');
 return results;
}
...
/* ================================================================
   ...
   ================================================================ */
const EB_BUILD={alpha:'0.8.53',engine:'EB-1.8.53'};
const EB_BALANCE_PATCH='CANDIDATE-A-NATURE-EARTH'; // 0.8.53 Candidate A: Growth is ATK-only; Stonewall grants +1 Armor.
const EB_BALANCE=(()=>{
 ...
 function makeDeck(el,r,responseEl=null){let a=[],pick=responseChoice(el,r,responseEl);if(PRIME.has(el)){for(let i=0;i<13;i++)a.push(card(el,BASE[el][i%3]));for(let i=0;i<7;i++)a.push(card(el,TECH[el],'TECHNIQUE'))}else{let h=HYBRIDS[el];a=[...primePack(h.parents[0],8),...primePack(h.parents[1],8),...HYBRID_CARDS[el].map(z=>card(el,z))]}a.push(responseSimCard(pick));a.forEach((c,i)=>{c.sid=`${el}:${i}`;c.marks=[];c.armor=0;c.growth=0;c.ready=false;c.sick=false});return{cards:shuffle(a,r),responseEl:pick}}
 function freshSide(el,r,responseEl=null){let built=makeDeck(el,r,responseEl);return{el,vit:30,maxE:2,e:2,deck:built.cards,hand:[],wake:[],slots:[null,null,null],marks:[],chain:0,responseEl:built.responseEl,initiationToken:false,turnState:{resonance:{a:false,b:false,active:false},parents:HYBRIDS[el]?.parents||[]}}}
 ...
 function attackBonus(st,owner,att,target){let p=st.p[owner],bonus=0;if(att.el==='FIRE'&&att.n==='Flare Hawk'&&(target.marks||[]).includes('Burning'))bonus++;
   ...
   if(att.el==='LIGHTNING'&&att.n==='Arc Runner'&&p.chain>=2)bonus++;
   ...
   if(att.el==='AIR'&&att.n==='Gale Scout'&&p.turnState.airOpening){bonus++;p.turnState.airOpening=false;metric(st,'effect','Air Opening')}
   if((target.marks||[]).includes('Charged')&&(att.el==='LIGHTNING'||att.el==='STORM')){bonus++;unmark(target,'Charged');metric(st,'effect','Charged released')}
   bonus+=(att.growth||0);return bonus}
 function dealBody(st,owner,t,power,source){let def=st.p[1-owner],pre=t.h,block=Math.min(t.armor||0,power);t.armor=(t.armor||0)-block;let d=Math.max(0,power-block);if(st.options.secondPlayerOpeningProtection&&(1-owner)!==st.startSeat&&!t._ebHasAttacked&&t.h-d<=0)d=Math.max(0,t.h-1);t.h-=d;if(d>0&&t.el==='WATER'&&t.n==='Tide Warden')flow(st,1-owner);if(source.el==='WATER'&&source.n==='River Serpent'&&d>0){let had=(t.marks||[]).includes('Soaked');mark(t,'Soaked');metric(st,'effect','Soaked applied');if(had){unmark(t,'Soaked');flow(st,owner);metric(st,'effect','Soaked payoff')}}if(t.h<=0){let idx=def.slots.indexOf(t),guardAtImpact=guards(def).length;if(st.metrics.initiative.firstRemoval===null){st.metrics.initiative.firstRemoval=owner;st.metrics.initiative.firstRemovalTurn=st.turn}if(!t._ebHasAttacked){let victim=1-owner;st.metrics.initiative.removedBeforeFirstAttack[victim]++;let key=(source&&source.type==='TECHNIQUE'?'TECHNIQUE:':'ATTACK:')+((source&&source.n)||'UNKNOWN');let bucket=st.metrics.initiative.preAttackRemovalBySource[victim];bucket[key]=(bucket[key]||0)+1;if(st.trace.length<120)st.trace.push({ev:'PRE_ATTACK_REMOVAL',turn:st.turn,by:owner,victim,unit:t.n,source:key});}if(idx>=0){def.slots[idx]=null;def.wake.push(t)}let overflow=guardAtImpact?0:Math.max(0,d-Math.max(0,pre));if(overflow){def.vit-=overflow;st.metrics.damage[owner]+=overflow;metric(st,'effect','Overflow')}}return d}
 ...
 function summonGift(st,owner,c){let p=st.p[owner],targets=p.slots.filter(m=>m&&m!==c);if(!targets.length)return;let t;if(c.el==='AIR'&&c.n==='Breeze Disciple'){t=targets.find(x=>x.n==='Sky Raptor')||targets.sort((a,b)=>b.a-a.a)[0];mark(t,'Momentum');metric(st,'effect','Momentum')}
   else if(c.el==='EARTH'&&c.n==='Stone Initiate'){t=targets.sort((a,b)=>b.h-a.h)[0];t.armor=Math.min(3,(t.armor||0)+1);metric(st,'effect','Armor')}
 ...
 function playTechnique(st,owner,c){let p=st.p[owner],e=st.p[1-owner],res=!!p.turnState.resonance.active;
   ...
   else if(c.el==='EARTH'){let t=p.slots.filter(Boolean).sort((a,b)=>(b.a+b.h)-(a.a+a.h))[0];if(t){t.armor=Math.min(3,(t.armor||0)+1);metric(st,'effect','Armor')}}
   else if(c.el==='NATURE'){let t=p.slots.filter(Boolean).sort((a,b)=>(a.h/a.max)-(b.h/b.max))[0];if(t){t.h=Math.min(t.max,t.h+2);if((t.marks||[]).includes('Seeded')&&(t.growth||0)<3){t.growth=(t.growth||0)+1;t.a++;metric(st,'effect','Growth')}}}
   else if(c.el==='LIGHTNING'){if(p.chain===2){mark(e,'Charged');metric(st,'effect','Charged applied')}else flow(st,owner)}
   else if(c.el==='AIR'){let from=e.slots.findIndex(Boolean),to=e.slots.findIndex(x=>!x);if(from>=0&&to>=0){e.slots[to]=e.slots[from];e.slots[from]=null;p.turnState.airOpening=true;metric(st,'effect','Crosswind move')}else flow(st,owner)}
   else if(c.el==='MAGMA'){let t=p.slots.filter(Boolean)[0];if(t){t.armor=Math.min(3,(t.armor||0)+1);metric(st,'effect','Armor')}if(res){let q=e.slots.find(x=>x&&(x.marks||[]).includes('Burning'));if(q)dealBody(st,owner,q,1,c)}}
   else if(c.el==='STORM'){let t=p.slots.filter(Boolean)[0],to=p.slots.findIndex(x=>!x);if(t&&to>=0){let from=p.slots.indexOf(t);p.slots[to]=t;p.slots[from]=null;mark(t,'Momentum');metric(st,'effect','Momentum');if(res){mark(t,'Charged');metric(st,'effect','Charged applied')}}}
   else if(c.el==='BLOOM'){let t=p.slots.filter(Boolean)[0];if(t){if(res){if((t.growth||0)<3){t.growth=(t.growth||0)+1;t.a++;metric(st,'effect','Growth')}}else if((t.marks||[]).includes('Seeded'))t.h=Math.min(t.max,t.h+1);else{mark(t,'Seeded');metric(st,'effect','Seeded')}}}
 }
 ...
 function simResponseLegal(el,def,att,t,phase='BEFORE'){if(!def||!att||!t)return false;if(phase==='AFTER')return el==='FIRE'&&def.slots.includes(t)&&t.h>0&&t.h<t.max;if(el==='FIRE')return false;if(el==='WATER')return def.slots.includes(t)&&def.slots.some(x=>!x);if(el==='NATURE')return def.slots.some(m=>m&&m.h<m.max);if(el==='EARTH')return def.slots.some(Boolean);if(el==='LIGHTNING')return true;if(el==='AIR')return def.slots.filter(Boolean).some(m=>m!==t);return false}
 ...
 function simShouldRespond(st,def,att,t,opt,phase){if(!opt)return false;let el=opt.el;if(phase==='AFTER')return el==='FIRE'&&def.slots.includes(t)&&att.h>0;let incoming=Math.max(0,att.a+(att.growth||0));if(el==='WATER'||el==='LIGHTNING')return true;if(el==='AIR')return def.slots.some(m=>m&&m!==t&&m.h>t.h)||incoming>=t.h;if(el==='EARTH')return incoming>=2||t.h<=incoming;if(el==='NATURE')return def.slots.some(m=>m&&m.h<m.max);return true}
 ...
 else if(el==='NATURE'){let pick=def.slots.filter(m=>m&&m.h<m.max).sort((a,b)=>a.h-b.h)[0];if(pick){let before=pick.h;pick.h=Math.min(pick.max,pick.h+2);let healed=pick.h-before;st.metrics.responses.secondBloomHealing+=healed;metric(st,'effect','Second Bloom healing',healed)}}
 else if(el==='EARTH'){let pick=def.slots.filter(Boolean).sort((a,b)=>(b.a+b.h)-(a.a+a.h))[0];if(pick){let before=pick.armor||0;pick.armor=Math.min(3,before+1);let gained=pick.armor-before;st.metrics.responses.stonewallArmor+=gained;metric(st,'effect','Stonewall Armor',gained)}}
 else if(el==='LIGHTNING'){let pre=att.h;att.h-=2;metric(st,'effect','Flash Step damage',Math.min(2,Math.max(0,pre)));if(att.h<=0){let atkSide=st.p[owner],i=atkSide.slots.indexOf(att);if(i>=0){atkSide.slots[i]=null;atkSide.wake.push(att)}cancel=true;st.metrics.responses.preCombatKills++}}
...
const EB_BALANCE_RULESET='EB-RULES-0.8.53-CANDIDATE-A';
const EB_BALANCE_LAB_VERSION='0.8.53';
...
function ebBalanceRenderResults(rep){let games=rep.rows.reduce((n,r)=>n+r.games,0),stalls=rep.rows.reduce((n,r)=>n+r.stalls,0),turns=rep.rows.reduce((n,r)=>n+r.turns,0),actions=rep.rows.reduce((n,r)=>n+r.actions,0),side=[0,0],reasons={},cards={},effects={};rep.rows.forEach(r=>{side[0]+=r.wins[0];side[1]+=r.wins[1];for(const[k,v]of Object.entries(r.reasons))reasons[k]=(reasons[k]||0)+v;for(const[k,v]of Object.entries(r.cards))cards[k]=(cards[k]||0)+v;for(const[k,v]of Object.entries(r.effects))effects[k]=(effects[k]||0)+v});let status=rep.cancelled?'CANCELLED — PARTIAL RESULTS':'COMPLETE';document.getElementById('blProgress').innerHTML=`<b class="${rep.cancelled?'blWarn':'blGood'}">${status}</b><div class="small">${games.toLocaleString()} games processed in ${(rep.elapsedMs/1000).toFixed(1)}s.</div><div class="devBar"><i style="width:${Math.round(games/rep.totalPlanned*100)}%"></i></div>`;document.getElementById('blSummary').innerHTML=`<b>GLOBAL SUMMARY</b><div class="blStatGrid"><div class="blStat"><small>Side A wins</small><b>${ebBLPct(side[0],games)}%</b></div><div class="blStat"><small>Side B wins</small><b>${ebBLPct(side[1],games)}%</b></div><div class="blStat"><small>Avg turns</small><b>${games?(turns/games).toFixed(2):'0'}</b></div><div class="blStat"><small>Avg actions</small><b>${games?(actions/games).toFixed(2):'0'}</b></div><div class="blStat"><small>Stalls</small><b>${stalls}</b></div><div class="blStat"><small>Completed</small><b>${games.toLocaleString()}</b></div></div><div class="blUtil"><b>Win reasons:</b> ${ebBLTop(reasons,8).map(x=>`${x[0]} ${x[1]}`).join(' · ')||'none'}<br><b>Top effects:</b> ${ebBLTop(effects).map(x=>`${x[0]} ${x[1]}`).join(' · ')||'none'}</div>`;ebBalanceRenderMatrix(rep);document.getElementById('blCopy').disabled=false}
...
async function ebBalanceCalibrationRun(){
 ...
 let decks=EB_BALANCE.DECKS,depth=EB_BL_DEPTH,mirror=[],pairRows=[],sideWins=[0,0],stalls=0,total=0,flips=0,stable=0,started=performance.now();
 try{
  box.innerHTML='<b>CALIBRATING…</b><div class="small">Paired deterministic seeds · seat-independent deck shuffles · shared action RNG.</div>';
  for(let ai=0;ai<decks.length;ai++){
   let a=decks[ai];
   for(let bi=ai;bi<decks.length;bi++){
    let b=decks[bi],r=EB_BALANCE.paired(a,b,depth,{seedBase:`EB0834CAL|${depth}`}),deckWins={[a]:0,[b]:0},localSide=[0,0],localStalls=0,localFlips=0,localStable=0;
    for(const q of r.pairs){
     for(const g of [q.ab,q.ba]){
      total++;
      if(g.stalled)localStalls++,stalls++;
      else {sideWins[g.winner]++;localSide[g.winner]++;deckWins[g.decks[g.winner]]=(deckWins[g.decks[g.winner]]||0)+1}
     }
     if(q.seatFlip)localFlips++,flips++;
     if(q.sameWinner)localStable++,stable++;
    }
    let row={a,b,games:r.games,sideA:localSide[0],sideB:localSide[1],stalls:localStalls,seatFlips:localFlips,stableWinner:localStable,deckWins};
    pairRows.push(row);if(a===b)mirror.push(row);
    if((pairRows.length%3)===0)await ebBLYield();
   }
  }
  let mirrorGames=mirror.reduce((n,r)=>n+r.games,0),mirrorA=mirror.reduce((n,r)=>n+r.sideA,0),mirrorB=mirror.reduce((n,r)=>n+r.sideB,0);
  let aPct=ebBLPct(sideWins[0],total-stalls),bPct=ebBLPct(sideWins[1],total-stalls),mAPct=ebBLPct(mirrorA,mirrorGames),mBPct=ebBLPct(mirrorB,mirrorGames);
  let bias=Math.max(aPct,bPct),mirrorBias=Math.max(mAPct,mBPct),detected=bias>=58||mirrorBias>=58;
  EB_BL_CAL_LAST={build:'0.8.39',ruleset:ebBalanceRuleset(),depth,total,stalls,sideWins,aPct,bPct,mirrorA,mirrorB,mAPct,mBPct,detected,flips,stable,mirror,pairRows,elapsedMs:Math.round(performance.now()-started)};
  box.innerHTML=`<b class="${detected?'blWarn':'blGood'}">Possible seat bias detected: ${detected?'YES':'NO'}</b>
  <div class="blStatGrid">
   <div class="blStat"><small>Overall A</small><b>${aPct}%</b></div><div class="blStat"><small>Overall B</small><b>${bPct}%</b></div>
   <div class="blStat"><small>Mirror A</small><b>${mAPct}%</b></div><div class="blStat"><small>Mirror B</small><b>${mBPct}%</b></div>
   <div class="blStat"><small>Seat-flip pairs</small><b>${flips}</b></div><div class="blStat"><small>Stable winner pairs</small><b>${stable}</b></div>
  </div>
  <div class="small">Calibration games: ${total.toLocaleString()} · stalls ${stalls} · ${(EB_BL_CAL_LAST.elapsedMs/1000).toFixed(1)}s</div>
  <div class="blUtil"><b>Mirror controls:</b><br>${mirror.map(r=>`${r.a}: A ${ebBLPct(r.sideA,r.games-r.stalls)}% / B ${ebBLPct(r.sideB,r.games-r.stalls)}%`).join('<br>')}</div>
  <div class="${detected?'blWarn':'blGood'}" style="margin-top:8px;font-weight:900">${detected?'BALANCE CONCLUSIONS: HOLD — diagnose seat/turn ordering before card tuning.':'CALIBRATION PASSED — normalized matchup analysis is suitable for the next balance pass.'}</div>`;
  copy.disabled=false;
...
function ebBalanceCalibrationText(){
 ...
 let r=EB_BL_CAL_LAST,lines=[`ELEMENT BOUND Alpha 0.8.39 BALANCE LAB CALIBRATION`,`Ruleset: ${r.ruleset}`,`Depth: ${r.depth} paired seeds`,`Calibration games: ${r.total}`,`Stalls: ${r.stalls}`,`Overall A win rate: ${r.aPct}%`,`Overall B win rate: ${r.bPct}%`,`Mirror A win rate: ${r.mAPct}%`,`Mirror B win rate: ${r.mBPct}%`,`Seat-flip pairs: ${r.flips}`,`Stable-winner pairs: ${r.stable}`,`Possible seat bias detected: ${r.detected?'YES':'NO'}`,`Balance conclusions: ${r.detected?'HOLD':'CALIBRATED'}`,'','MIRROR CONTROLS'];
 for(const m of r.mirror)lines.push(`${m.a} mirror | A ${ebBLPct(m.sideA,m.games-m.stalls)}% | B ${ebBLPct(m.sideB,m.games-m.stalls)}% | games ${m.games} | stalls ${m.stalls}`);
 lines.push('','SEAT-NORMALIZED MATCHUPS');
 for(const x of r.pairRows){if(x.a===x.b)continue;let valid=x.games-x.stalls,aw=x.deckWins[x.a]||0,bw=x.deckWins[x.b]||0;lines.push(`${x.a} vs ${x.b} | ${x.a} ${ebBLPct(aw,valid)}% | ${x.b} ${ebBLPct(bw,valid)}% | games ${x.games} | seat-flip pairs ${x.seatFlips} | stable-winner pairs ${x.stableWinner} | stalls ${x.stalls}`)}
 return lines.join('\n');
}
...
async function ebInitiativeAuditRun(){
 ...
 try{box.innerHTML='<b>RUNNING INITIATIVE COMPENSATION AUDIT…</b><div class="small">50+ paired seeds per mirror · alternating starters · current rules vs second-player +1 opening card.</div>';
  ...
  EB_INIT_LAST={build:'0.8.39',ruleset:ebBalanceRuleset(),depth,total:rows.reduce((n,r)=>n+r.games,0),rows,summary,delta,diagnosis,elapsedMs:Math.round(performance.now()-started)};
...
async function ebTempoLabRun(){
 ...
 try{box.innerHTML='<b>RUNNING TEMPO LAB VII…</b><div id="blTempoProgress" class="small">Preparing finalist calibration…</div><div class="devBar"><i id="blTempoBar"></i></div><div class="small">Paired mirror seeds · five simulator-only finalists · role/seat pairing · sequencing · lifecycle · first-removal correlation.</div>';
  ...
  EB_TEMPO_LAST={build:'0.8.44',ruleset:ebBalanceRuleset(),depth,total:rows.reduce((n,x)=>n+x.games,0),rows,summary,pairs,traces,elapsedMs:Math.round(performance.now()-started)};
...
function ebBalanceClear(){if(EB_BL_RUNNING)return;EB_BL_LAST=null;document.getElementById('blSummary').innerHTML='<b>NO REPORT YET</b><div class="small">Run the lab to generate matchup, turn-length, utilization and stall telemetry.</div>';document.getElementById('blProgress').innerHTML='<b>READY</b><div class="small">No simulation is running.</div><div class="devBar"><i id="blBar"></i></div>';document.getElementById('blMatrixWrap').classList.add('blHidden');document.getElementById('blDetail').classList.add('blHidden');document.getElementById('blCopy').disabled=true}
...
console.info('Elementbound Alpha 0.8.47 · Response System loaded');