(function(root,factory){
  ...
  function reject(state,error,detail){
    return {ok:false,error,detail:detail||null,state};
  }
  ...
  function validateAndApplyMove(state,move){
    ...
    const next=clone(state);let error=null;
  ...
  return Object.freeze({ACTION_VERSION,ACTIONS,validEnvelope,validState,validateAndApplyMove});
});
